                ...
                <nav aria-label="Global"> 
                    <ul class="flex items-center gap-12 text-m"> 
                     ...
                     <div class="sm:flex sm:gap-4"> 
                        <a class="inline-block rounded-sm border border-sky-700 px-12 py-3 text-sm font-medium text-sky-700 hover:bg-sky-700 hover:text-white focus:ring-3 focus:outline-hidden" href="#" >
